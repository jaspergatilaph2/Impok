            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">
                        <span class="text-muted fw-light">History Settings /</span>
                        Transaction History
                    </h4>
                            ...
                            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#">
                                        <i class="bx bx-wallet me-1"></i> Transactions
                                    </a>
                                </li>
                            </ul>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="printArea" class="report-container">
                                        ...
                                        <div class="text-center mb-2">
                                            <h4 class="fw-bold mb-0 report-title">Impoks Transaction Report History</h4>
