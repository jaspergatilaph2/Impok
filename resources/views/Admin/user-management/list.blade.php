            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveTabMenu === 'View' ? 'active' : '' }}">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{ $SubActiveTab === 'users' ? 'active' : '' }}">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Admin User Management /</span>Show User List
                    </h4>
                                                                ...
                                                                <div class="text-start px-3">
                                                                    ...
                                                                    <div class="row mb-2">
                                                                        ...
                                                                        <div class="col-7 fw-semibold">
                                                                            {{ optional($user->profile_information)->first_name ?? 'N/A' }}
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-2">
                                                                        ...
                                                                        <div class="col-7 fw-semibold">
                                                                            {{ optional($user->profile_information)->last_name ?? 'N/A' }}
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-2">
                                                                        ...
                                                                        <div class="col-7 fw-semibold">
                                                                            {{ optional($user->profile_information)->phone ?? 'N/A' }}
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-2">
                                                                        ...
                                                                        <div class="col-7 fw-semibold">
                                                                            {{ optional($user->profile_information)->birthdate ?? 'N/A' }}
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-7 fw-semibold">
                                                                            {{ optional($user->profile_information)->address ?? 'N/A' }}
                                                                        </div>
                                                                    </div>
