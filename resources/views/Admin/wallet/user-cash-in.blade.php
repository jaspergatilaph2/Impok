            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveTabMenu === 'View' ? 'active' : '' }}">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{ $SubActiveTab === 'wallet' ? 'active' : '' }}">
                    ...
                    <div class="row">
                            ...
                            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                <li class="nav-item">
                                    <a class="nav-link active" href="javascript:void(0);">
                                        <i class="bx bx-group me-1"></i> User List
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="card mb-4">
                                ...
                                : ($user->avatar
                                    ...
                                    : asset('sneat/img/avatars/1.png')) }}"
                                                    ...
                                                    <td class="user-first">
                                                        {{ $user->profile_information ? $user->profile_information->first_name : 'N/A' }}
                                                    </td>

                                                    <td class="user-last">
                                                        {{ $user->profile_information ? $user->profile_information->last_name : 'N/A' }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-success"
                                                            ...
                                                            data-bs-target="#walletViewModal{{ $user->id }}">
                                                            More..
                                                        </button>
                                                    </td>
                                                ...
                                                <!-- CASH IN MODAL -->
                                                <div class="modal fade" id="walletViewModal{{ $user->id }}" tabindex="-1">
                                                        ...
                                                        <div class="modal-content shadow border-0">
                                                            ...
                                                            <div class="modal-header bg-primary text-white">
                                                                <h5 class="modal-title text-white">
                                                                    <i class="bx bx-wallet me-2"></i> Wallet Balance
                                                                </h5>
                        ...
                        : ($user->avatar
                            ...
                            : asset('sneat/img/avatars/1.png')) }}"
                                                                ...
                                                                <p class="fw-bold mb-1">Transaction Dates:</p>

                                                                @php
                                                                $latest = ($user->wallet ?? collect())->sortByDesc('created_at')->first();
                                                                @endphp

                                                                <ul class="list-unstyled">
                                                                    @if($latest)
                                                                    <li>
                                                                        {{ \Carbon\Carbon::parse($latest->transaction_date ?? $latest->created_at)->format('M d, Y') }}
                                                                        - {{ ucfirst(str_replace('_', ' ', $latest->type)) }}
                                                                    </li>
                                                                    @else
                                                                    <li class="text-muted">No transactions found</li>
                                                                    @endif
                                                                </ul>
