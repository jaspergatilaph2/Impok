            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveTabMenu === 'View' ? 'active' : '' }}">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{ $SubActiveTab === 'Trash-bin' ? 'active' : '' }}">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="container">
                        ...
                        <h3 class="mb-4 fw-bold text-primary text-center text-md-start">
                            <i class="fa-solid fa-delete-left me-2"></i> Deleted Messages
                        </h3>

                        <p class="text-muted text-center text-md-start">
                            View messages sent to users and system notifications.
                        </p>
                                    ...
                                    <table class="table table-hover align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!-- DATE -->
                                                <td>
                                                    {{ optional($msg->created_at)->format('M d, Y') ?? '-' }}
                                                </td>

                                                <!-- SENDER -->
                                                <td>
                                                    {{ optional($msg->sender->profileInformation)->first_name ?? 'Admin' }}
                                                    {{ optional($msg->sender->profileInformation)->last_name ?? '' }}
                                                </td>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            <li>
                                                                <a href="#"
                                                                    ...
                                                                    data-sender="{{ optional($msg->sender->profileInformation)->first_name ?? 'Admin' }} {{ optional($msg->sender->profileInformation)->last_name ?? '' }}"
                                                                    data-date="{{ optional($msg->created_at)->format('M d, Y') }}">
                                                                    <i class="bi bi-eye"></i>
                                                                    View
                                                                </a>
                                                            </li>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p><strong>Subject:</strong> <span id="modalTitle"></span></p>
